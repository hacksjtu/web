...
export default {
  cn: {
    ...
    faqAnswers: [
      ...
      ' HACK×SJTU 将面向全国各类高校，学生申请者提交申请后，我们将从所有申请人当中优选出全国300名学生来复旦大学参加 HACK×SJTU 活动。<br> 我们坚信“创新是人文与技术的结合体，缺一不可。”我们鼓励各类主修的学生参与，无论你是学社会科学类，还是学基础理、工科类的学生，我们都将欢迎你的申请加入！',
    ...
    // Footer
    rightStatement: 'HACK×SJTU All rights reserved<br>葡萄科技技术（深圳）有限公司'
  },
  ...
  en: {
    ...
    Now Fudan University will also join this movement by creating  HACK×SJTU  this Fall semester.
     HACK×SJTU  will select 300 best student developers across China and
    ...
    HACK×SJTU  will last for 36 hours throughout October 14th weekend,
    ...
    faqAnswers: [
      ...
      'HACK×SJTU will be available for any kinds of students to apply across China. After submitting your application, we will select the best 300 student talents from the application pool to participate in HACK×SJTU. <br> We firmly believe that Innovation is a combination of arts and sciences. We are looking for the best talents across different majors. No matter your major is in general arts, mathematics, engineering field, we welcome you to apply for  HACK×SJTU !',
    ...
    rightStatement: 'HACK×SJTU All rights reserved<br>Grape Tech (Shenzhen) LLC'
  }
